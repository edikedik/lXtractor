    ...
    [
        ...
        (
            ...
            dict(
                ...
                link_points_to="r",
                transform="".join,
                empty_target=lambda x: x == "X",
            ),
            "AABCDE",
        ),
        (
            ChainSequence.from_string("ABYD", r=list(range(10, 14))),
            ChainSequence.from_string("AAXXDE", r=list(range(9, 15))),
            dict(
                template="seq1",
                target="seq1",
                link_name="r",
